  ...
  return (
    <div className="min-h-screen bg-[#0a0f1e] flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div
          className="absolute -bottom-40 -right-40 w-96 h-96 bg-indigo-600/20 rounded-full blur-3xl animate-pulse"
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <p className="text-center text-slate-600 text-xs mt-4">
          Demo: Register as Recruiter or Candidate to explore
        </p>
      </div>
    </div>
  );
